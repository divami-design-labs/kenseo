...
var paintPdf = function(payload) {
    ...
    var ScaleValue = Math.abs(MIN_SCALE - 1);
    var Range = MAX_SCALE - MIN_SCALE;
    $thumb.css({
        'left': (ScaleValue/Range * 100).toFixed(2) + "%"
    }).attr('range-value', "100%");
