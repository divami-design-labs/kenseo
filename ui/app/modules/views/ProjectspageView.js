Kenseo.views.Projectspage = Backbone.View.extend({
    ...
    render: function() {
        ...
        sb.renderTemplate({"templateName": 'artefacts',"templateHolder": $('.artifacts-content.sub-section-content'), "collection": this.artefactsCollection, "data": {projects: true, project_id: Kenseo.page.data.project_id, sharePermission: false, sortBy: "default"}});
