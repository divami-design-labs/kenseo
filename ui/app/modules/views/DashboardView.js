Kenseo.views.Dashboard = Backbone.View.extend({
    ...
    render: function() {
        sb.renderTemplate({"templateName": 'db-projects-section', "templateHolder": $('.projects-section-content'), "collection": this.collections.projectCollection, "data": {limit: 6, userProjects: true}}});
