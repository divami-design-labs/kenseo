            ...
            if (!plugin.settings.always_visible) {
                ...
                if (plugin.settings.container.is('body')) {
                    ...
                    var
                        ...
                        left = (undefined !== icon ? icon.parent().offset().left: $element.offset().left + $element.outerWidth(true)),
                    ...
                    if (plugin.settings.default_position == 'below')
                        top = (undefined !== icon ? icon.parent().offset().top + icon.parent().height() : $element.offset().top);
