...
$AppGlobal['cmdmap']['getProjectDetails'] = array ("class" => "Projects", "method" => "getProjectDetails");
$AppGlobal['urlmap']['/getProjectDetails'] = array ('command' => 'getProjectDetails', 'type' => 'GET');
...
$AppGlobal['cmdmap']['getProjectActivities'] = array ("class" => "Notifications", "method" => "getProjectActivities");
$AppGlobal['urlmap']['/getProjectActivities'] = array ('command' => 'getProjectActivities', 'type' => 'GET');

$AppGlobal['cmdmap']['renameArtefact'] = array ("class" => "Artefacts", "method" => "renameArtefact");
$AppGlobal['urlmap']['/renameArtefact'] = array ('command' => 'renameArtefact', 'type' => 'GET');

$AppGlobal['cmdmap']['editArtefact'] = array ("class" => "Artefacts", "method" => "editArtefact");
$AppGlobal['urlmap']['/editArtefact'] = array ('command' => 'editArtefact', 'type' => 'GET');
...
$AppGlobal['cmdmap']['personPermissions'] = array ("class" => "People", "method" => "personPermissions");
$AppGlobal['urlmap']['/personPermissions'] = array ('command' => 'personPermissions', 'type' => 'GET');
...
$AppGlobal['cmdmap']['updateMeeting'] = array ("class" => "Meetings", "method" => "updateMeeting");
$AppGlobal['urlmap']['/updateMeeting'] = array ('command' => 'updateMeeting', 'type' => 'GET');
...
$AppGlobal['cmdmap']['submitArtefact'] = array ("class" => "Artefacts", "method" => "submitArtefact");
$AppGlobal['urlmap']['/submitArtefact'] = array ('command' => 'submitArtefact', 'type' => 'GET');
...
$AppGlobal['cmdmap']['shareArtefact'] = array ("class" => "Artefacts", "method" => "shareArtefact");
$AppGlobal['urlmap']['/shareArtefact'] = array ('command' => 'shareArtefact', 'type' => 'GET');
